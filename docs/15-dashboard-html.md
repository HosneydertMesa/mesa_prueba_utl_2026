...
- Comparativo de votos totales CA para Tunja, Paipa, Sogamoso y Duitama.
...
- El exportador valida los cuatro municipios antes de escribir artefactos.
...
- 4 municipios, 73 puestos y 1.107 mesas;
