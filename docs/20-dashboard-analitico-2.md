...
dentro del mismo `dashboard/index.html`. Las secciones obligatorias, los cuatro
municipios, colores, ratios, modo oscuro y CSV permanecen sin cambios.
...
Los contratos verifican identidad JSON/HTML, schema v2, matriz 8×4, 1.107 puntos,
estadísticos observados, controles interactivos y ausencia de recursos externos.
